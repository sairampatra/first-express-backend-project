...
//         if (!file) {
//             console.log(file);  // Logs the file object for debugging
//             return cb(new Error("File not found"));  // Rejects the request if no file is uploaded
//         }
//         if (file.mimetype !== "image/jpeg" && file.mimetype !== "image/png") {
//             return cb(new Error("File type not supported"));  // Rejects unsupported file types
//         }
//         // console.log(file); // Logs the file object for debugging
